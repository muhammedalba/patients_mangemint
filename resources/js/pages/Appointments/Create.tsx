...
export default function Create({  patients, doctors, procedures }: PageProps<{ patients: Patient[], doctors: User[], procedures: Procedure[] }>) {
    const { data, setData, post, errors, processing } = useForm({
        patient_id: '',
        user_id: '',
        procedure_id: '',
        appointment_date: '',
        times: [], // Initialize with an empty array
        notes: '',
        status: 'scheduled',
    });
