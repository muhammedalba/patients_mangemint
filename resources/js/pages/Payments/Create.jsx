...
export default function Create() {
    ...
    const [form, setForm] = useState({ patient_id:'', amount:0, date:'' });

    const handleChange = (e) => setForm({...form, [e.target.name]: e.target.value});
    const handleSubmit = (e) => { e.preventDefault(); Inertia.post(route('payments.store'), form); };

    return (
        <div>
            <h1 className="text-2xl font-bold mb-4">إضافة دفعة</h1>
