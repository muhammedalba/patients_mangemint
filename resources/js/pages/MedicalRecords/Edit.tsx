...
export default function Edit({
    ...
    console.log(medicalRecord, 'medicalRecord edit');
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('medical-records.update', medicalRecord.id), {
            preserveScroll: true,
        });
    };
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <select
                                    ...
                                    className="mt-1 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800"
                                >
                                    <option value="">اختر المريض</option>

                                    <option value={medicalRecord.patient?.id}>
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <input
                                ...
                                onChange={(e) =>
                                    setData('allergic_to', e.target.value)
                                }
                                className="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800"
                            />
                            <textarea
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setData('hospital_details', e.target.value)
                                }
                                className="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800"
                            />
                        </div>
                        ...
                        <div className="flex justify-end gap-4">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="rounded-lg bg-indigo-600 px-6 py-2 text-white transition hover:bg-indigo-700 disabled:opacity-50"
                            >
